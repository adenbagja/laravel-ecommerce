            ...
            <div class="col-md-12">
                <div class="wrap-address-billing">
                    ...
                    <div class="billing-address"></div>
                        ...
                        <p class="row-in-form">
                            <label for="city">Line1:</label>
                            <input  type="text" name="city" value="" placeholder="City name"wire:model="line1">
                            @error('line1') <span class="text-danger">{{$message}}</span>  @enderror
                        </p>
                        <p class="row-in-form">
                            <label for="city">Line2:</label>
                            <input  type="text" name="city" value="" placeholder="City name"wire:model="line2">
                        </p>
                        <p class="row-in-form">
                ...
                <div class="wrap-address-billing">
                    ...
                    <div class="billing-address"></div>
                        ...
                        <p class="row-in-form">
                            ...
                            <input  type="number" name="zip-code" value="" placeholder="Province" wire:model="s_province">
            ...
            <div class="summary-item payment-method">
                ...
                <div class="choose-payment-methods">
                    <label class="payment-method">
                        ...
                        <span class="payment-desc">Order Noy Pay on Delivery</span>
                    </label>
                    <label class="payment-method">
